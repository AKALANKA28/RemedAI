...
| Multi-Agent Architecture & Orchestration | `backend/app/graph/workflow.py`, `backend/app/agents/` |
...
| Individual Agent Design | prompts and agent classes under `backend/app/agents/` |
